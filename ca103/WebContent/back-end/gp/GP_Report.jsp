...
<body>
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">揪團檢舉</li>
		</ol>
	</nav>
		...
		<div class="row">
			...
			<div class="col-10">
           		<h2 class="text-center bg-warning p-4 text-white">
        			<img src="<%=request.getContextPath()%>/sources/icon/secondShop/check.png">揪團檢舉
        		</h2>
				<jsp:include page="GP_Report0.jsp"/>
			</div>
		</div>
	</div>
