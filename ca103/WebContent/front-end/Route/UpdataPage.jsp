...
<br>
			...
			<div class="col-12">
			    <div class="card" style="height:460px">
					<div class="card-header">
						<div><b>路線名稱：</b><input class="form-control form-control-sm" placeholder="請輸入路線名稱" type="text" name="rot_name" style="width:250px; display:inline;" value="${routeVO.rot_name}" maxlength="25"></div>
					...
					<div class="col-6">
						...
						<footer class="blockquote-footer text-right ">建立者： <cite title="Source Title"><%= memVO.getMem_nickname() %></cite></footer>
					</div>
				</div>
		    </div>
	    </div>
							...
							<div class="row">
								<div class="col-12">
									<div class="card-deck">
										<div class="card">
											<div class="card-body">
												<h5><b>路線難度：</b><b id="rot_hardText">${ routeVO.rot_hard }</b></h5>
												<h5><b>路線距離：</b><b id="rot_disText">${ routeVO.rot_dis }</b></h5>
											</div><span class="glyphicon glyphicon-question-sign"></span>
										</div>
										<div class="card">
											<div class="card-body">
												<h5><b>爬升高度：</b><b id="rot_height_upText">${ routeVO.rot_height_up }</b></h5>
												<h5><b>下降高度：</b><b id="rot_height_downText">${ routeVO.rot_height_down }</b></h5>
												<h5><b>海拔最高：</b><b id="rot_heightestText">${ routeVO.rot_height_ave }</b></h5>
											</div>
										</div>
										<div class="card">
											<div class="card-body">
												<h5><b>爬升累計坡度：</b><b id="rot_slope_upText">${ routeVO.rot_slope_up }</b></h5>
												<h5><b>爬升平均坡度：</b><b id="rot_slope_downText">${ routeVO.rot_slope_down }</b></h5>
												<h5><b>高度平均坡度：</b><b id="rot_slope_aveText">${ routeVO.rot_slope_ave }</b></h5>
											</div>
										</div>
									</div>
									<br>
									...
									<div class="container">
										<div class="row justify-content-end">
											...
											<div class="col-auto">
												...
												<button type="button" class="btn btn-primary" onclick="updateRoute(this)">確定</button>
	...
	<%-- 這邊的form表單是為了取消修改的按鈕,取消修改後會讓頁面跳轉回路線詳細資訊的頁面 --%>
	<form action="<%=request.getContextPath()%>/Route/RouteServlet.do" Method="POST" name="cancelUpdata">
